...
describe Aypex::Admin::TaxonsController, type: :controller do
  stub_authorization!
  ...
  describe "#remove_icon" do
    ...
    let!(:taxon_image) { Aypex::TaxonImage.new }
    let!(:image_file) { File.open(Aypex::Core::Engine.root + "spec/fixtures" + "thinking-cat.jpg") }
