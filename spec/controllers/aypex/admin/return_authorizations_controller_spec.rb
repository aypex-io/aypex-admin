...
describe Aypex::Admin::ReturnAuthorizationsController, type: :controller do
  stub_authorization!
  ...
  context "#create" do
    ...
    it "can create a return authorization" do
      subject
      expect(response).to redirect_to aypex.admin_order_return_authorizations_path(order)
    end
  end
    ...
    context "adding an item" do
      ...
      context "without existing items" do
        it "creates a new item" do
          expect { subject }.to change { Aypex::ReturnItem.count }.by(1)
        end
      end
      ...
      context "with existing completed items" do
        ...
        it "does not create new items" do
          expect { subject }.not_to change { Aypex::ReturnItem.count }
