      ...
      xdescribe "#destroy" do
        ...
        context "will successfully destroy store credit" do
          ...
          describe "returns response" do
            ...
            it { expect(flash[:message]).to eq(I18n.t("aypex.successfully_removed", resource: "Store Credit")) }
          end
        end
        ...
        context "cannot destroy store credit with used amount" do
          ...
          it { expect { send_request }.to raise_error(Aypex::Admin::StoreCreditError) }
        end
      end
    end
  end
