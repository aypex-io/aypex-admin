  ...
  module Admin
    class CustomerReturnsController < ResourceController
      ...
      def location_after_save
        aypex.edit_admin_order_customer_return_path(@order, @customer_return)
      end

      def build_resource
        Aypex::CustomerReturn.new
      end
      ...
      def build_return_items_from_params
        ...
        @customer_return.return_items = return_items_params.map do |item_params|
          ...
          return_item = item_params[:id] ? Aypex::ReturnItem.find(item_params[:id]) : Aypex::ReturnItem.new
