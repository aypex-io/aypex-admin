  ...
  module Admin
    class WebhooksSubscribersController < ResourceController
      ...
      def location_after_save
        aypex.edit_admin_webhooks_subscriber_path(@object)
      end

      def resource
        @resource ||= Aypex::Admin::Resource.new "aypex/admin/webhooks/subscribers", "subscribers", nil
      end
      ...
      def load_data
        @supported_events ||= Aypex::Webhooks::Subscriber.supported_events
      end
    end
  end
end
