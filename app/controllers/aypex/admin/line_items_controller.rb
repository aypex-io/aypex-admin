  ...
  module Admin
    class LineItemsController < ResourceController
      ...
      def add_item_service
        Aypex::Dependencies.line_item_add_item_service.constantize
      end

      def create_service
        Aypex::Dependencies.line_item_create_service.constantize
      end

      def update_service
        Aypex::Dependencies.line_item_update_service.constantize
      end

      def destroy_service
        Aypex::Dependencies.line_item_destroy_service.constantize
      end
