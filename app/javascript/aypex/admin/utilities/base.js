...
if (!window.AypexAdmin) { window.AypexAdmin = AypexAdmin }

const platformApiMountedAt = function () { return window.AypexAdmin.paths.platform_api_mounted_at }
...
AypexAdmin.localizedPathFor = function (path) {
